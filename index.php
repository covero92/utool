...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-3 col-xl-2 min-vh-100 py-4 d-flex flex-column gap-4 position-sticky top-0"
            ...
            <div class="mt-4 px-3">
                <h6 class="text-secondary fw-bold text-uppercase small mb-3 opacity-75" style="letter-spacing: 1px;">
                    Online Agora</h6>
                ...
                <?php else: ?>
                    <ul class="list-unstyled mb-0 d-flex flex-column gap-2">
                        <?php foreach ($onlineUsers as $u):
                            ...
                            ?>
                            <li
                                class="d-flex align-items-center bg-white bg-opacity-50 p-2 rounded-3 border border-white shadow-sm">
                                <div class="position-relative">
                                    ...
                                    <span
                                        class="position-absolute bottom-0 end-0 p-1 <?php echo $statusColor; ?> border border-white rounded-circle"></span>
                                </div>
                                <div class="ms-3 lh-1">
                    ...
                    <?php else: ?>
                        <div class="d-flex flex-column gap-3">
                            <?php foreach ($latestPosts as $post):
                                ...
                                ?>
                                <a href="fiscal_blog.php?q=<?php echo urlencode($post['title']); ?>"
                                    class="text-decoration-none text-dark card border-0 shadow-sm p-3 hover-card"
                                    style="background: rgba(255,255,255,0.7);">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-2 py-1"
                                            style="font-size: 0.65rem;"><?php echo htmlspecialchars($post['category']); ?></span>
                                        <small class="text-muted"
                                            style="font-size: 0.65rem;"><?php echo date('d \d\e M', strtotime($post['date'])); ?></small>
                                    </div>
                                    <div class="fw-bold small lh-sm text-truncate-2" style="font-size: 0.85rem;">
        ...
        <div class="col-lg-9 col-xl-10 py-5 px-5">
            ...
            <div class="mb-5">
                <div class="row align-items-center mb-5">
                    <div class="col-md-5">
                        <div class="d-inline-flex align-items-center gap-3 user-select-none">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-0 fw-medium opacity-75">Portal de ferramentas e
                                    utilitários.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="position-relative">
                            <i
                                class="bi bi-search position-absolute top-50 start-0 translate-middle-y ms-4 text-primary opacity-50 fs-5"></i>
                            <input type="text" id="tool-search"
                                class="form-control form-control-lg rounded-pill border-0 ps-5 py-3 text-dark shadow-sm"
                                placeholder="O que você procura hoje?" onkeyup="filterTools()">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end" style="position: relative; z-index: 1060;">
                        <?php if ($loggedIn): ?>
                            <div class="dropdown">
                                <button
                                    class="btn btn-white shadow-sm rounded-pill px-3 py-2 dropdown-toggle text-primary fw-bold border-0"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 rounded-4 p-2">
                                    <li>
                                        <h6 class="dropdown-header">Minha Conta:
                                            <?php echo htmlspecialchars($currentUser); ?>
                                        </h6>
                                    </li>
                                    <li><a class="dropdown-item rounded-3" href="profile.php"><i
                                    ...
                                    <?php endif; ?>
                                    <li><a class="dropdown-item rounded-3" href="#" data-bs-toggle="modal"
                                            data-bs-target="#changePassModal"><i class="bi bi-key me-2"></i>Alterar
                                            Senha</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                        ...
                        <?php else: ?>
                            <button class="btn btn-sm btn-primary shadow-sm rounded-pill px-4 fw-bold"
                                data-bs-toggle="modal" data-bs-target="#portalLoginModal">
                ...
                <div class="row g-4 mb-4">
                            ...
                            <div
                                ...
                                <div class="card-body p-4 position-relative z-1 d-flex flex-column justify-content-between">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <h6 class="text-uppercase text-secondary fw-bold small opacity-75 mb-0"
                                            style="letter-spacing: 1px;">Senha Técnica</h6>
                                        <div class="bg-primary bg-opacity-10 p-2 rounded-3 text-primary">
                                            <i class="bi bi-key-fill fs-5"></i>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-end justify-content-between mt-3">
                                        <h2 class="display-1 fw-bold widget-value mb-0 text-primary">
                                            <?php echo $password; ?>
                                        </h2>
                    ...
                    <?php if ($permManager->canView('weather', $currentRoleId)): ?>
                        <div class="col-md-4">
                            <div id="weather-card"
                                class="card border-0 shadow-sm rounded-4 h-100 position-relative overflow-hidden group-action hover-card transition-all"
                                style="transition: all 0.5s ease;">
                                <?php if ($isSupport): ?>
                                    <button
                                        class="btn btn-sm btn-light btn-action position-absolute top-0 end-0 m-2 rounded-circle shadow-sm"
                                        style="width: 28px; height: 28px; padding: 0;" onclick="openWeatherModal()"><i
                                            class="bi bi-pencil-fill text-primary" style="font-size: 0.7rem;"></i></button>
                                <?php endif; ?>
                                <div class="card-body p-4 d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="text-uppercase text-secondary fw-bold small opacity-75 mb-2"
                                            style="letter-spacing: 1px;">Clima & Tempo</h6>
                                        <div class="d-flex align-items-baseline">
                                            <h3 class="widget-value mb-0 me-2 text-dark" style="font-size: 2.5rem;"
                                                id="weather-temp">--</h3>
                                            <span class="small text-muted fw-bold" id="weather-desc">...</span>
                                        </div>
                                        <div class="small text-muted mt-1 fw-medium"><i
                                                class="bi bi-geo-alt-fill me-1 text-danger opacity-75"></i> <span
                    ...
                    <!-- Version Widget -->
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm rounded-4 h-100 position-relative overflow-hidden group-action hover-card cursor-pointer"
                            onclick="window.location.href='release_notes.php'" style="cursor: pointer;">
                            <?php if ($isAdmin): ?>
                                <button
                                    class="btn btn-sm btn-light btn-action position-absolute top-0 end-0 m-2 rounded-circle shadow-sm"
                                    style="width: 28px; height: 28px; padding: 0;" onclick="openVersionModal()"><i
                                        class="bi bi-pencil-fill text-primary" style="font-size: 0.7rem;"></i></button>
                            <?php endif; ?>
                            <div class="card-body p-4 position-relative z-1 d-flex flex-column justify-content-between">
                                <div class="d-flex justify-content-between align-items-start">
                                    <h6 class="text-uppercase text-secondary fw-bold small opacity-75 mb-0"
                                        style="letter-spacing: 1px;">Versão Uniplus</h6>
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="d-flex justify-content-between align-items-end mt-1">
                                        <p class="text-secondary mb-0 lh-sm fw-medium">Data
                                            release:<br><span
                                                class="text-dark fs-5"><?php echo $build['date']; ?></span></p>
            ...
            <div class="mb-5 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                <div class="nav nav-pills gap-3 d-flex flex-nowrap overflow-auto py-2 w-100" id="hub-nav"
                    ...
                    <button
                        class="nav-link bg-white text-secondary rounded-pill px-4 fw-bold shadow-sm d-flex align-items-center gap-2 flex-shrink-0"
                        onclick="filterCategory('suporte', this)">
                        <i class="bi bi-people-fill"></i> Suporte
                    </button>
                    <button
                        class="nav-link bg-white text-secondary rounded-pill px-4 fw-bold shadow-sm d-flex align-items-center gap-2 flex-shrink-0"
                        onclick="filterCategory('retaguarda', this)">
                        <i class="bi bi-server"></i> Suporte Retaguarda
                    </button>
                    <button
                        class="nav-link bg-white text-secondary rounded-pill px-4 fw-bold shadow-sm d-flex align-items-center gap-2 flex-shrink-0"
                        onclick="filterCategory('fiscal', this)">
                        <i class="bi bi-receipt"></i> Fiscal
                    </button>
                    <button
                        class="nav-link bg-white text-secondary rounded-pill px-4 fw-bold shadow-sm d-flex align-items-center gap-2 flex-shrink-0"
                        onclick="filterCategory('utilitarios', this)">
                ...
                <div class="flex-shrink-0">
                    <div class="dropdown">
                        <button
                            class="btn btn-white shadow-sm rounded-pill px-3 py-2 fw-bold text-secondary d-flex align-items-center gap-2"
                            type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-grid-fill"></i> <span class="d-none d-md-inline">Visualização</span>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 rounded-4 p-2">
                            <li>
                                <h6 class="dropdown-header small text-uppercase fw-bold">Layout</h6>
                            </li>
                            <li><button class="dropdown-item rounded-3 d-flex align-items-center gap-2 py-2"
                                    onclick="setView('list')"><i class="bi bi-list-ul"></i> Lista</button></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li>
                                <h6 class="dropdown-header small text-uppercase fw-bold">Tamanho da Grade</h6>
                            </li>
                            <li><button class="dropdown-item rounded-3 d-flex align-items-center gap-2 py-2"
                                    onclick="setView('grid-sm')"><i class="bi bi-grid-3x3"></i> Pequena</button></li>
                            <li><button class="dropdown-item rounded-3 d-flex align-items-center gap-2 py-2"
                                    onclick="setView('grid-md')"><i class="bi bi-grid-fill"></i> Média (Padrão)</button>
                            </li>
                            <li><button class="dropdown-item rounded-3 d-flex align-items-center gap-2 py-2"
                                    onclick="setView('grid-lg')"><i class="bi bi-square-fill"></i> Grande</button></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div id="tools-main-container">
                ...
                <div class="mb-5 tool-section" id="sec-suporte">
                    ...
                    <div class="row g-4 helper-row-container">
                        ...
                        <?php endif; ?>
                        <?php
                        renderCard('card-team-ppr', 'Gestão PPR', ' Novo Dashboard de Metas e Resultados.', 'ppr_manager.php', 'bg-warning-gradient', 'bi-trophy-fill', $portal, $isAdmin);
                        ?>
                ...
                <!-- Suporte Retaguarda -->
                <div class="mb-5 tool-section" id="sec-retaguarda">
                    <h3 class="section-title text-secondary mb-4"><i class="bi bi-server me-2"></i>Suporte Retaguarda
                    </h3>
                    <div class="row g-4 helper-row-container">
                        <?php
        ...
        <div class="modal-content border-0 bg-transparent shadow-lg">
            <div class="card card-glass overflow-hidden rounded-5 border-0">
                <div class="row g-0">
                    ...
                    <div
                        class="col-lg-5 d-none d-lg-flex flex-column justify-content-center align-items-center bg-primary bg-gradient p-5 text-white text-center position-relative overflow-hidden">
                        ...
                        <div class="position-relative z-1">
                            <div class="bg-white text-primary rounded-circle d-flex align-items-center justify-content-center shadow-lg mb-4"
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4">
                <form id="changePassForm" onsubmit="changePassword(event)">
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control rounded-4 bg-light border-0" id="currentPass"
                            name="current_password" required placeholder="Atual">
                        <label for="currentPass">Senha Atual</label>
                    </div>
                    <div class="form-floating mb-4">
                        <input type="password" class="form-control rounded-4 bg-light border-0" id="newPassModal"
                            name="new_password" required placeholder="Nova">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit"
                            class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm">Salvar</button>
                    </div>
                </form>
            </div>
        </div>
...
<style>
    ...
    .bg-orange-gradient {
        background: linear-gradient(135deg, #fd7e14 0%, #e35d0b 100%);
    }
        ...
        <form id="weatherForm" class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="city" id="weatherInputCity"
                        value="<?php echo htmlspecialchars($weatherConfig['city'] ?? 'Brusque'); ?>" required>
                </div>
                <div class="row">
                    <div class="col-6 mb-3">
                        <label class="form-label small fw-bold">Latitude</label>
                        <input type="number" step="any" class="form-control" name="lat" id="weatherInputLat"
                            value="<?php echo htmlspecialchars($weatherConfig['lat'] ?? '-27.1177'); ?>" required>
                    </div>
                    <div class="col-6 mb-3">
                        <label class="form-label small fw-bold">Longitude</label>
                        <input type="number" step="any" class="form-control" name="lon" id="weatherInputLon"
                            value="<?php echo htmlspecialchars($weatherConfig['lon'] ?? '-48.9103'); ?>" required>
                    </div>
                </div>
            </div>
        ...
        <form id="noticeForm" class="modal-content">
            ...
            <div class="modal-footer border-0 pt-0">
                <button type="button" class="btn btn-primary w-100 rounded-pill"
                    onclick="saveNotice()">Adicionar</button>
            </div>
        </form>
    </div>
</div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 bg-white"
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button type="button" class="btn btn-primary rounded-pill px-4"
                    onclick="saveCardPermissions()">Salvar</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <div class="modal-body p-4">
                <form id="changePassForm">
                    ...
                    <button type="button" class="btn btn-primary w-100 rounded-pill" onclick="savePassword()">Salvar
                        Nova Senha</button>
                </form>
            </div>
        </div>
